...
1. Add a wildcard DNS record: `*.scribe.wedding` → Vercel
2. Configure the domain in Vercel dashboard
3. Update `NEXTAUTH_URL` to `https://scribe.wedding`
